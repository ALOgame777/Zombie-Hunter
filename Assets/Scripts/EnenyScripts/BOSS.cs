...
public class BOSS : MonoBehaviour
{
    ...
    // 체력 UI가 보스 근처에 갔을때만 생기도록 ㄱㄱ
    public Slider HPsliderBOSS;
    public float showDistance = 1000.0f; // 버튼이 보이는 거리
    private Transform playerposition; // 플레이어 위치 추적
    private CanvasGroup BossHPcanvasgroup; // 투명도와 상호작용 관리하는 캔버스
    ...
    void Start()
    {
        ...
        BossHPcanvasgroup = HPsliderBOSS.GetComponent<CanvasGroup>(); // 문 열기에서 캔버스그룹 찾기
    ...
    {
        BossHPcanvasgroup.alpha = 1;
        BossHPcanvasgroup.interactable = true;
        BossHPcanvasgroup.blocksRaycasts = true;
    }

    private void HideSlider() // 슬라이더 숨기기
    {
        BossHPcanvasgroup.alpha = 0;
        BossHPcanvasgroup.interactable = false;
        BossHPcanvasgroup.blocksRaycasts = false;
    }
